    ...
    <section id="how-it-works" style={{ padding: '6rem 0' }}>
      <Container>
        ...
        <div style={{ display: 'grid', gap: '2rem', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))' }}>
          {[
            { step: 1, title: 'Chrome에 추가', desc: '크롬 웹 스토어에서 MindLock을 무료로 설치하세요.' },
            { step: 2, title: '차단 목록 설정', desc: '집중을 방해하는 사이트 URL을 입력하여 차단 목록에 추가하세요.' },
            { step: 3, title: '집중 모드 시작', desc: '타이머를 설정하고 시작 버튼을 누르면 즉시 차단이 적용됩니다.' }
          ].map((item) => (
